...
#create public subnets pu_sub_1a
resource "aws_subnet" "pu_sub_1a" {
    vpc_id = aws_vpc.vpc.id
    cidr_block = var.pu_sub_1a_cidr
...
#create public subnets pu_sub_2b
resource "aws_subnet" "pu_sub_2b" {
    vpc_id = aws_vpc.vpc.id
    cidr_block = var.pu_sub_2b_cidr
